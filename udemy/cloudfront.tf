...
resource "aws_cloudfront_distribution" "cf" {
  ...
  origin {
    ...
    s3_origin_config {
      origin_access_identity = aws_cloudfront_origin_access_identity.cf-s3-origin-access-identity.cloudfront_access_identity_path
    }
  }
...
resource "aws_cloudfront_origin_access_identity" "cf-s3-origin-access-identity" {
